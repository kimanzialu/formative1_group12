...
class _RsvpButtonState extends State<RsvpButton> {
  void _toggleRsvp() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(widget.event.isRsvped? 'You have RSVP\'d to ${widget.event.title}!': 'You are no longer RSVP\'d.'),
        backgroundColor: widget.event.isRsvped? Colors.green: Colors.grey,
      ...
      children: [
        ...
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: widget.event.isRsvped ? Colors.green : const Color(0xFFF9A826),
          ...
          child: Text(
            widget.event.isRsvped ? 'Going' : 'RSVP',
